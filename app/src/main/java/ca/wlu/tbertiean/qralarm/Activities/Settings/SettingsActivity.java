...
import ca.wlu.tbertiean.qralarm.Activities.AppCompatPreferenceActivity;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class AlarmPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setHasOptionsMenu(true);
            bindPreferenceSummaryToValue(findPreference("alarm_snooze_time"));
    ...
    public static class DataPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setHasOptionsMenu(true);
            findPreference("data_clear").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    Helper.clearSharedPreferences(preference.getContext());
                    Toast.makeText(preference.getContext(), "All alarms have been deleted.", Toast.LENGTH_SHORT).show();
                    return false;
                }
            });
        }
